...
import { Plus, FileText, Calendar, AlertTriangle, ChevronUp, ChevronDown } from 'lucide-react';
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        />
                                        <Calendar className="absolute right-12 top-1/2 -translate-y-1/2 h-4 w-4 text-[var(--c-muted)] pointer-events-none" />
                                    </div>
                                </div>
                                <div className="space-y-1.5">
                                    <div className="flex items-center justify-between">
                        ...
                        <div className="rounded-3xl border border-[var(--c-border)] bg-[var(--c-surface)] p-6 shadow-sm space-y-6">
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="flex h-10 items-center rounded-xl border border-[var(--c-border)] bg-[var(--c-panel)] px-4 text-sm font-black text-emerald-500 shadow-inner">
                                        {profit.toFixed(2)}
                                    </div>
                                </div>
