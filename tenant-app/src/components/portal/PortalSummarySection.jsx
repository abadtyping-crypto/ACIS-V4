      ...
      .map((item, index) => {
        ...
        return `
          <tr>
            ...
            <td style="color:${balanceTone}; font-weight:700;">AED ${escapeHtml(formatCurrency(balance))}</td>
          </tr>
        `;
      })
      .join('');
        ...
        <body>
          ...
          <div class="summary">
            ...
            <div class="stat">
              ...
              <div class="value">AED ${escapeHtml(formatCurrency(selectedBalanceTotal))}</div>
            </div>
            <div class="stat">
