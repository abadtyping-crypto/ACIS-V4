...
const AppFooter = ({ appName = 'ACIS' }) => {
  ...
  return (
    <>
      ...
      <footer className="desktop-footer px-3 pb-3 pt-2" style={{ fontSize: '16px' }}>
        <div
          className={`glass flex items-center justify-between gap-3 rounded-2xl border border-[var(--c-border)] ${
