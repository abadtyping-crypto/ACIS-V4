  ...
  return (
    <>
      ...
      >
        ...
        {/* Animated chat dots above button */}
        ...
        {/* Bot icon */}
        <div className="relative z-10 w-12 h-12 rounded-full overflow-hidden shadow-[0_8px_24px_-8px_rgba(0,0,0,0.32)] bg-white border border-[var(--c-border)]">
          <img src="/boticon.png" alt="Ayman Bot" className="w-full h-full object-contain p-2" />
        </div>
      </div>
    </>
  );
