...
const baseWrapperClass = 'compact-field relative flex h-10 items-center overflow-hidden rounded-xl border border-[var(--c-border)] bg-[var(--c-panel)] text-[var(--c-text)] shadow-sm transition focus-within:border-[var(--c-accent)] focus-within:ring-4 focus-within:ring-[var(--c-accent)]/5 disabled:opacity-50';
                    ...
                    {showCopyButton && value ? (
                        <button
                            ...
                            className={`flex h-8 w-8 items-center justify-center rounded-lg transition-colors ${
                                isCopied ? 'text-emerald-500' : 'text-[var(--c-muted)] hover:bg-[var(--c-surface)] hover:text-[var(--c-accent)]'
                            }`}
        ...
        <div className={`${baseWrapperClass} ${className}`.trim()}>
            ...
            {onAppend ? (
                <button
                    type="button"
                    onClick={onAppend}
                    className="flex h-10 shrink-0 items-center gap-1 border-l border-[var(--c-border)] bg-[var(--c-panel)] px-4 text-[11px] font-bold uppercase tracking-wide text-[var(--c-muted)] transition hover:bg-[color:color-mix(in_srgb,var(--c-accent)_10%,var(--c-panel))] hover:text-[var(--c-accent)]"
