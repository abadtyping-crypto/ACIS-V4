...
const IconSelect = ({
    ...
    const triggerClass = [
        'compact-field flex h-10 w-full items-center justify-between rounded-xl',
            ...
            >
                {leftIconSlot ? (
                    <span className="min-w-0 flex-1 flex items-center">
                        <span className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-l-xl border-r border-[var(--c-border)] bg-[color:color-mix(in_srgb,var(--c-panel)_88%,var(--c-surface)_12%)]">
