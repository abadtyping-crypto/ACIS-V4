    ...
    <div ref={rootRef} className={`relative ${className}`.trim()}>
      ...
      >
        <span className="flex min-w-0 flex-1 items-center">
          <span className="relative flex h-[3.5rem] w-[3.5rem] shrink-0 items-center justify-center overflow-hidden border-r border-[var(--c-border)] bg-[linear-gradient(165deg,color-mix(in_srgb,var(--c-surface)_88%,white_12%),color-mix(in_srgb,var(--c-panel)_90%,transparent))] shadow-[inset_0_1px_0_rgba(255,255,255,0.65),inset_0_-8px_14px_rgba(15,23,42,0.08)]">
            <span className="pointer-events-none absolute inset-[1px] rounded-[10px] bg-[radial-gradient(circle_at_30%_22%,rgba(255,255,255,0.45),transparent_52%)]" />
            {selected ? (
              <img
                src={resolveSystemIcon(systemAssets, selected.icon, '/dependent.png')}
                alt=""
                className="relative z-[1] h-full w-full scale-[1.38] object-cover drop-shadow-[0_4px_8px_rgba(15,23,42,0.2)]"
              />
            ) : (
                ...
                return (
                  ...
                  >
                    <span className="flex h-8.5 w-8.5 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[var(--c-border)] bg-white shadow-[inset_0_0_0_1px_rgba(255,255,255,0.45)]">
                      <img src={resolveSystemIcon(systemAssets, item.icon, '/dependent.png')} alt="" className="h-full w-full object-cover" />
                    </span>
