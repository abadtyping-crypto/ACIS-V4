    ...
    return (
        <div ref={wrapperRef} className="relative w-full">
            <div
                ...
                className={`flex w-full cursor-pointer items-center h-10 gap-3 border bg-[var(--c-panel)] transition-all ${
                    isCompact ? 'compact-field rounded-xl px-3' : 'compact-field rounded-xl px-3'
                } ${isOpen ? 'border-[var(--c-accent)] ring-4 ring-[var(--c-accent)]/5' : 'border-[var(--c-border)]'
                    }`}
            >
                <div className={`flex flex-shrink-0 items-center justify-center bg-[var(--c-surface)] text-[var(--c-muted)] ${isCompact ? 'h-7 w-7 rounded-lg' : 'h-8 w-8 rounded-lg'}`}>
            ...
            {canEditDescription ? (
                <div className="mt-2">
                    <textarea
                        ...
                        className="compact-field w-full rounded-xl border border-[var(--c-border)] bg-[var(--c-panel)] px-3 py-2 text-xs font-semibold text-[var(--c-text)] outline-none transition focus:border-[var(--c-accent)]"
                    />
                    <label className="mt-2 inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-[var(--c-muted)]">
                        <input
                            type="checkbox"
