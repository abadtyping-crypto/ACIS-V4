        ...
        <div className="relative w-full" ref={wrapperRef}>
            ...
            {isOpen && (
                <div className="absolute left-0 right-0 z-[100] mt-2 overflow-hidden rounded-2xl border border-[var(--c-border)] bg-[var(--c-surface)] shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                    <div className="border-b border-[var(--c-border)] bg-[var(--c-panel)] px-3 py-2">
                        <input
                            autoFocus
                            type="text"
                            value={query}
                            ...
                            className="w-full bg-transparent text-[11px] font-black uppercase tracking-widest text-[var(--c-text)] outline-none"
                        />
                    </div>
