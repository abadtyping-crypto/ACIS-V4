...
const IDRulesSection = () => {
  ...
  const handleSave = useCallback(async () => {
    ...
    setIsSaving(false);
  }, [tenantId, clientIdMode, rules, docRefs, user]);
    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-[var(--c-border)] bg-[color:color-mix(in_srgb,var(--c-panel)_42%,transparent)] p-3">
            <p className="mb-3 text-xs font-bold uppercase tracking-wider text-[var(--c-muted)]">Document Filename Policy (UI Draft)</p>
            <p className="mb-3 text-xs text-[var(--c-muted)]">
              UI only for now. Backend wiring is intentionally not connected yet.
            </p>
            <div className="space-y-3">
