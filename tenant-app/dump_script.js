...
async function run() {
  const filePath = 'c:\\Users\\SAMY-LAP\\Desktop\\ACIS V4\\tenant-app\\public\\ocrScanSample\\RPM UAQ.pdf';
  const data = new Uint8Array(fs.readFileSync(filePath));
  const text = await extractPdfText({ arrayBuffer: async () => data });
  fs.writeFileSync('c:\\Users\\SAMY-LAP\\Desktop\\ACIS V4\\tenant-app\\pdf_dump.txt', text);
